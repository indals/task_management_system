...
if __name__ == '__main__':
    ...
    if args.reset:
        ...
        # Override sample data creation if flag is set
        original_create_sample_data = create_sample_data
        if args.no_sample_data:
            create_sample_data = lambda: print("⏭️  Skipping sample data creation")
        
        init_database()
        
        # Restore original function
        create_sample_data = original_create_sample_data